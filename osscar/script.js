...
// ВАЖНО: подставьте URL СВОЕГО Google Apps Script (деплой из apps-script.gs).
// Пока стоит PASTE_... — форма ничего не отправляет (заявки никуда не уходят).
window.FORM_CONFIG = {
